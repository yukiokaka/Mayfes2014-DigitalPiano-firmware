...
void* const vector[] __attribute__ ((section(".VECTOR"))) =	/* Vector table to be allocated to address 0 */
{
    ...
    trap,//CT32B0_IRQHandler,//CT32B0_IRQHandler,
    trap,//CT32B1_IRQHandler,//CT32B1_IRQHandler,
...
{
    /* switch */
    LPC_IOCON->PIO0_2 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_3 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_4 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_5 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_6 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_7 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_8 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO0_9 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->SWCLK_PIO0_10 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->R_PIO0_11 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->R_PIO1_0 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO1_4 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO1_5 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
    LPC_IOCON->PIO1_8 |= (1 << 5); /* Pull-up,Hysteresis Enable */ 
